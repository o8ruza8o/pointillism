...
def drawCircle(ctx, center, radius, color):
    ...
    ctx.arc(center[1], center[0], radius, -pi, pi)
...
if __name__=='__main__':
    ...
    with  open(filename.split(".")[0]+'-data.csv', "w") as datafile:
        ...
        for point in points:
            drawCircle(ctx, point.p, radius/2.0, point.c/255.0)
